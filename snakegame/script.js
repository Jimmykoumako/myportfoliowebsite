window.onload = function() {
    ...
    function gameOver(){
        ...
        ctx.fillText("Game Over", centreX - 1, centreY - 180);
        ctx.font = "bold 30px sans-serif";
        ctx.strokeText("Appuyer sur la touche Espace pour rejouer", centreX, centreY - 120);
        ctx.fillText("Appuyer sur la touche Espace pour rejouer", centreX - 1, centreY - 120);
        ctx.restore();
    }
    ...
    function Apple(position){
        ...
        this.isOnSnake = function(snakeToCheck){
            ...
            for (const element of snakeToCheck.body) {
                if(this.position[0]=== element[0] &&
                    this.position[1]=== element[1])
                    isOnSnake = true;
            }
